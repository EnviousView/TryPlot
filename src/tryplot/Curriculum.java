...
public class Curriculum {
    ...
    private double dblDay1;
    private double dblDay2;
    private double dblDay3;
    
    public Curriculum(String strCourseCode, String strCourseName, int iCourseStudUnits, int iCourseLecUnits, int iNumDays, String strPairingDays, double dblDay1, double dblDay2, double dblDay3)
    {
